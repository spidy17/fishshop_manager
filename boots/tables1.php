...
<div class="formpost">
<form action="tables1.php" id="formid" method="post">
  ...
  <div class="col-md-2">
       <form action="tables1.php"  method="post">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    <th>Name <form action="tables1.php" method="post"><button type="submit" class="btn btn-link" name="asc"><i class="fa fa-arrow-up" aria-hidden="true"></i></i></button><button type="submit" class="btn btn-link" name="desc"><i class="fa fa-arrow-down" aria-hidden="true"></i></i></button></th>
                    <th>Email</th>
                    <th>Address</th>
...
while($row=mysqli_fetch_array($result)):?>
                  <tr>
                   ...
                   <td> <button class="btn btn-success" name="inst"> <a href="insertform.php?id=<?php echo $row['id'];?>" class="text-white">Update</a></button></td>
                  </tr>
 ...
 <div class="modal fade" id="mymodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body"><form action="tables.php" name="myform" onsubmit="return validateform()" method="post">
<div id="fo">
   Name:<br>
...
<div class="modal fade" id="mymodels" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">ADD DATA OF CUSTOMER</h5>
