...
<div class="formpost">
<form action="fishhistory1.php" id="formid" method="post">
  ...
  <div class="col-md-2">
       <form action="fishhistory.php"  method="post">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    <th>Fish ID <form action="fish1.php" method="post"><button type="submit" class="btn btn-link" name="asc"><i class="fa fa-arrow-up" aria-hidden="true"></i></i></button><button type="submit" class="btn btn-link" name="desc"><i class="fa fa-arrow-down" aria-hidden="true"></i></i></button></th>
                    <th>Type</th>
                    <th>Price</th>
