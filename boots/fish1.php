...
<div class="formpost">
<form action="fish1.php" id="formid" method="post">
  ...
  <div class="col-md-2">
       <form action="fish1.php"  method="post">
 ...
 <div class="modal fade" id="mymodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body"><form action="fish1.php" name="myform" onsubmit="return validateform()" method="post">
<div id="fo">
   Id:<br>
